...
internal class OnNavigationHandledIntentExecutorDelegate :
    MviKotlinIntentCoroutineExecutorDelegate {
    ...
    override fun execute(
        ...
        if (intent != Intent.OnNavigationHandled) return false

        executor.dispatch(
            Message.UpdateNavigationState(navigationState = null)
        )
